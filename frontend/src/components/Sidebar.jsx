...
const Sidebar = () => {
  ...
  return (
    <div
      className="flex flex-col my-auto ml-5 p-5 bg-zinc-800 rounded-xl"
      style={{ height: "95vh", width: "20vw" }}
    >
      <div className="mx-auto">
        <img src={logo} alt="logo flexcore" className="w-64 mt-3" />
      </div>
      <nav className="mt-12 text-white">
        <ul className="space-y-5">
          <li
            className={
              location.pathname === "/dashboard"
                ? "bg-purple-500 rounded-lg w-48 font-bold p-3"
                : "p-3 hover:bg-purple-400 hover:rounded-lg hover:w-48 hover:cursor-pointer"
            }
          >
          ...
          <li
            className={
              location.pathname === "/materia-prima"
                ? "bg-purple-500 rounded-lg w-48 font-bold p-3"
                : "p-3 hover:bg-purple-400 hover:rounded-lg hover:w-48 hover:cursor-pointer"
            }
          >
